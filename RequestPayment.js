function RequestPayment(Addresss)
{
  ...
  const message = Converter.asciiToTrytes(
    `This is the addres JB9BCZAVZRCHIKUHYERPAW99KFXBSFJXWXPO9PZFIKZBTTCQPQVAKPXUJGNDZHCYYNJBSZWGDTORJUKOB`
  )
...
let promise=RequestPayment('JB9BCZAVZRCHIKUHYERPAW99KFXBSFJXWXPO9PZFIKZBTTCQPQVAKPXUJGNDZHCYYNJBSZWGDTORJUKOB');
promise.then((res)=> {
